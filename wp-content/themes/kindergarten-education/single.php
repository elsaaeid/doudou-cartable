	    ...
	    <div class="main-wrapper">
	        ...
	        if($kindergarten_education_layout_option == 'One Column'){ ?>
				<div class="content_box">
					<?php if (get_theme_mod('kindergarten_education_single_post_bradcrumb',false) != ''){ ?>
		    ...
		    <?php }else if($kindergarten_education_layout_option == 'Left Sidebar'){ ?>
		    	<div class="row">
		    		<div id="sidebar" class="<?php if( get_theme_mod( 'kindergarten_education_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-4 col-md-4<?php } else { ?>col-lg-3 col-md-4 <?php } ?> pt-3"><?php get_sidebar(); ?></div>
			...
			<?php } else {?>
				<div class="row">
					...
					<div id="sidebar" class="<?php if( get_theme_mod( 'kindergarten_education_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-4 col-md-4<?php } else { ?>col-lg-3 col-md-4 <?php } ?> pt-3"><?php dynamic_sidebar('sidebar-1'); ?></div>
				</div>
			<?php }?>
