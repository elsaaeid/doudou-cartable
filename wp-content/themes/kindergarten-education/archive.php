    ...
    <div class="container">
        ...
        <?php }else if($kindergarten_education_layout_option == 'Three Columns'){ ?>
            <div class="row">
                ...
                <div id="services_section" class="blog-section col-lg-6 col-md-6 pt-3">
                    <?php
                        the_archive_title( '<h1 class="page-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
        ...
        <?php }else if($kindergarten_education_layout_option == 'Four Columns'){ ?>
            <div class="row">
                <div id="sidebar" class="col-lg-3 col-md-3 pt-3"><?php dynamic_sidebar('sidebar-1'); ?></div>
                <div id="services_section" class="blog-section col-lg-3 col-md-3 pt-3">
                    <?php
                        the_archive_title( '<h1 class="page-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
        ...
        <?php }else if($kindergarten_education_layout_option == 'Grid Layout'){ ?>
            <div class="row">
                <div id="services_section" class="blog-section col-lg-8 col-md-8 pt-3">
                    <?php
                        the_archive_title( '<h1 class="page-title">', '</h1>' );
                        the_archive_description( '<div class="taxonomy-description">', '</div>' );
                    ?>
