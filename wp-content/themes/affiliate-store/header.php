...
<div class="mainhead">
  <?php if(get_theme_mod('affiliate_store_enable_topbar_section', false) != ''){ ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-6 col-12 align-self-center d-flex justify-content-between align-items-center">
            ...
            <?php }?>
            <?php if(get_theme_mod('affiliate_store_header_currency_switcher', false) != ''){ ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 align-items-center d-flex social-main-sec">
          <?php if(get_theme_mod('affiliate_store_enable_social_section', false) != ''){ ?>
