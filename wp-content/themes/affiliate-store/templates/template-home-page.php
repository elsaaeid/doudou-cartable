...
<div id="content" >
    <?php
        $affiliate_store_hidepageboxes = get_theme_mod('affiliate_store_slider', false);
    ...
    <?php
        $affiliate_store_hide_trending_section = get_theme_mod('affiliate_store_disabled_trending_section', false);
