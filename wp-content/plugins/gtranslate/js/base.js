(function(){
    ...
    var flyout_content = document.querySelector('.elementor-204 .elementor-element.elementor-element-8e63887 .hfe-flyout-content');
    add_code.innerHTML = widget_code;
    flyout_content.innerHTML = add_code;
