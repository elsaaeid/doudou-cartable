(function(){
    ...
    if(switcher_horizontal_position != 'inline')
        widget_code = '<div class="gt_switcher_wrapper" style="position:fixed;'+switcher_vertical_position+':0px;'+switcher_horizontal_position+':0px;z-index:999999;">' + widget_code + '</div>';
